    ...
    <div>
        ...
        <div class="row" v-else>
            <div class="col-md-8" v-if="itemsInBasket">
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input
                            ...
                            :class="[{'is_invalid': errorFor('customer.first_names')}]"
                        >
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input
                            ...
                            :class="[{'is_invalid': errorFor('customer.last_name')}]"
                        >
                ...
                <div class="row">
                    <div class="col-md-12 form-group">
                        ...
                        <input
                            ...
                            :class="[{'is_invalid': errorFor('customer.email')}]"
                        >
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label class="mt-4" for="street">Street</label>
                        <input
                            type="text"
                            class="form-control"
                            name="street"
                            v-model="customer.street"
                            :class="[{'is_invalid': errorFor('customer.street')}]"
                        >
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input
                            ...
                            :class="[{'is_invalid': errorFor('customer.city')}]"
                        >
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input
                            ...
                            :class="[{'is_invalid': errorFor('customer.country')}]"
                        >
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <input
                            ...
                            :class="[{'is_invalid': errorFor('customer.state')}]"
                        >
                        <v-errors :errors="errorFor('customer.state')"></v-errors>
                    </div>
                    <div class="col-md-2 form-group">
                        <label class="mt-4" for="zip">Zip</label>
                        <input
                            type="text"
                            class="form-control"
                            name="zip"
                            v-model="customer.zip"
                            :class="[{'is_invalid': errorFor('customer.zip')}]"
                        >
            ...
            <div class="col-md-4">
                <div class="d-flex justify-content-between">
                    ...
                    <h6 class="badge badge-secondary text-uppercase color">
                ...
                <transition-group name="fade" tag="div">
                    <div v-for="item in basket" :key="item.bookable.id">
                        ...
                        <span>
                            ...
                            <span class="font-weight-bolt">${{ item.price.total }}</span>
                        </div>
                        <div class="pt-2 pb-2 d-flex justify-content-between">
                            <span>From {{ item.dates.from }}</span>
                            <span>To {{ item.dates.to }}</span>
                        </div>
                        <div class="pt-2 pb-2 d-flex text-right">
